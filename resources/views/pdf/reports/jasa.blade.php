...
@section('title', 'Laporan Layanan Jasa')
@section('report_title', 'LAPORAN PENJUALAN LAYANAN JASA')
    ...
    <table class="table-data">
        <thead>
            <tr>
                ...
                <th width="35%">Nama Layanan (Jasa)</th>
                <th width="10%" class="text-center">Qty (Lbr)</th>
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="6" class="text-center">Belum ada data penjualan jasa.</td>
                </tr>
            @endforelse
        </tbody>
        <tfoot>
            <tr>
                ...
                <td class="text-center font-bold">{{ number_format($totalLembar, 0, ',', '.') }} Lbr</td>
                <td></td>
